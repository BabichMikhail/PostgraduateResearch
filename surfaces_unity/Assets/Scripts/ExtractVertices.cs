                    ...
                    foreach (var triangleAmount in pathItemAmount.Value) {
                        ...
                        if (paintAmounts != null) {
                            foreach (var t in paintAmounts.amountItems) {
                                ...
                                DictUtils.SumValue(paintAmountByPointAndPathItem[point], pathItem, amount);
                            }
                        }
                    }
                }
